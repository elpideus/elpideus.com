...
/**
 * Proxima, the journal star. The map itself lives in the root layout and is never
 * torn down, so a route only carries the readable twin of its star.
 */
export const metadata: Metadata = starMetadata(StarId.Proxima);

export default function JournalPage() {
  return <StarDocument id={StarId.Proxima} />;
}
