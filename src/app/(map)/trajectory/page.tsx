...
/**
 * Polaris, the trajectory star. The map itself lives in the root layout and is never
 * torn down, so a route only carries the readable twin of its star.
 */
export const metadata: Metadata = starMetadata(StarId.Polaris);

export default function TrajectoryPage() {
  return <StarDocument id={StarId.Polaris} />;
}
